...
<body>
    ...
    <!-- Contenido principal -->
    <div id="contenido-principal" class="relative sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-blue-100 dark:bg-dots-lighter dark:bg-blue-900 selection:bg-green-500 selection:text-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col items-center justify-center h-full">
                ...
                <p class="text-blue-800">
                        ...
                        <ul class="list-disc list-inside mt-4">
                            ...
                            <li>Amplia disponibilidad: Trabajamos con una extensa green de compañías de autobuses en todo el país, lo que nos permite ofrecerte una amplia gama de opciones para tus viajes. Desde destinos populares hasta lugares más remotos, FastBus te brinda acceso a una amplia disponibilidad de pasajes.</li>
                ...
                <a href="#" class="bg-green-500 hover:bg-green-600 text-white font-semibold py-2 px-4 rounded mt-4 inline-block">Reserva ahora</a>
            </div>
        </div>
    </div>
